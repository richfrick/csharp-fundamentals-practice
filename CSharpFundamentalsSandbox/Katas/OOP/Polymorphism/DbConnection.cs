...
namespace CSharpFundamentalsSandbox.Katas.OOP.Polymorphism
{
    public abstract class DbConnection
    {
        ...
        // Timeout : TimeSpan
        //
        // A DbConnection will not be in a valid state if it doesn’t have a connection string. So you need to pass a connection string in the constructor of this class.
        ...
        protected DbConnection(string connectionString, TimeSpan? timeout = null)
        {
            if (!string.IsNullOrWhiteSpace(connectionString))
            {
                ...
                Console.WriteLine("Establishing connection to {0} ..........", connectionString);
                Console.WriteLine("Will timeout in {0} mins if unsuccessful", timeout);
            }
            else
            {
                throw new NoNullAllowedException("missing Connection String");
            }
        }
