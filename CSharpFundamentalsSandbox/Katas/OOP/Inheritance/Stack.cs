...
namespace CSharpFundamentalsSandbox.Katas.OOP.Inheritance
{
    public class Stack
    {
        ...
        //We use the “object” type here so we can store any objects inside the stack. Remember the “object” class is the base of all classes in the .NET Framework.
        ...
        //
        //The Pop() method removes the object on top of the stack and returns it. Make sure to take into account the scenario that we call the Pop() method on an empty stack.
        ...
        //
        //Note: The downside of using the object class here is that if we store value types (eg int, char, bool, DateTime) in our Stack,
        ...
        public void Push(object obj)
        {
            if (obj != null)
                ...
                throw new InvalidOperationException("Unable to stack value of null");
        }
